...
| EX 2 | Exercises: 14, 15, 17, 18, 28, 35, 39, 41,42                         | N, R |
...
covered in the two previous lectures. Numbers refer to those in file:All.pdf.
...
(Representatives should make themselves known to their fellow students)
*** Remarks on exercises
- Extra points only on planned exercises
- Students have proposed that instead of them explaining their solution
  directly on the board, they'd prefer the following process:
...
- 14 people support (35 present at the lecture)
