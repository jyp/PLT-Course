...
*** Schedule
See [[https://web.timeedit.se/chalmers_se/db1/timeedit/p/public/r.html?sid=3&h=t&p=20120116.x,20120331.x&objects=201044.182&ox=0&types=0&fe=0][timeedit]].
*** Formal requirements
- Pass the exam
...
*** TODO Transformation: Algebraic data type ⟶ inheritance
...
- write a function that does the dot-product of a vector;
- then /abstract/.
...
*** TODO: Note that explicit thunks are not as good as support for lazyness as in haskell. Why?
...
Finally, metavariables can be bound to each other. That is,
if we have
: x =:= y 
