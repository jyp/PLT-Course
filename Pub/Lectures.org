...
- PAKCS
  ...
  + Linux (tested on Ubuntu Oneiric):
    ...
    - download the PACKS Linux binary http://www.informatik.uni-kiel.de/~pakcs/download/pakcs_Linux.tar.gz
    - untar
    - make     
...
:   where x free 
fails 
(actually KiCS2 extends this and returns something!)
