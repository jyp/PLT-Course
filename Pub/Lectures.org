...
file:Template/ContinueAccum.hs
** TODO State
Using continuation we can implement get and put.

file:Template/ContinueState.hs
...
*** Example
Let us write a query-reply server. It is convenient to have one
process handling each client.
