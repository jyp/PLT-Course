...
\question{*,@3} Define an algebraic type for binary trees 
...
\question{*,@3} Translate the interpreter. You must use 'instanceof'.

\subsection{Currification and partial application}

\question{*,@3} Define a function f following this spec.  Given a integer, return it
