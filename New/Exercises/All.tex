...
a y y   =:= a z z where x, y, z free
a x x   =:= a b c where x free
a x     =:= a b b where x free
a x x y =:= a z w w where x, y, w, z free
\end{verbatim}
...
\begin{verbatim}
dconcat x y z where x, y, z free
fromList [1,2,3] x where x free
fromList [4,5] y where y free
toList z final where z, final free
\end{verbatim}
