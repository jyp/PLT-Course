...
\question{*,@4} Write a version of filter which takes an explicit closure as an argument. 
Remember to write (and use) an apply function.
...
\question{*, @5} How would you find the first 100 prime numbers?
