...
How to read this document
 + As html http://cse.chalmers.se/~bernardy/pp/Lectures.html (beta)
 + Use the source, Luke: 
...
*** Lectures
- The lecture notes (this document) can be accessed at
  http://cse.chalmers.se/pp/Lectures.html
- You can also use the source if you fancy emacs org-mode.
- Please interrupt me during lectures!
*** TODO Exercises
Time:
Your group: subscribe by filling in this form:
*** TODO Office hours
- JP:
- Ramona:
- ...
