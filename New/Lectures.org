...
** Transformation: Recursive procedures <-> Explicit stack
...
** Transformation: Imperative programming --> functional programming

Idea: pass around the "state of the world".
...
Assuming the "state of the world" is only the contents of the output file, then print does...
...
Read: http://en.wikipedia.org/wiki/Communicating_sequential_processes


manual scheduler    <-->  concurrent processes


 Continuations as closures
...
Performace of inverted functions can be terrible.
