...
Write the original class hierarchy in a C++-like or Java-like language.\points{10}
...
\end{enumerate}
\answer{
  type Obsever = Event e -> IO Bool
  
  onPress :: Button -> Observer -> IO ()
  
  myPrintAction text = do
...
\item Write the code for primitives to read and write references. \points 3
