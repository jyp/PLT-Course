...
\comment{
I changed the functions to be called f and g,
and the ints to be called m and n. It was
a bit confusing.
}
...
\comment{
Changed function name Hanoi to hanoi
}
...
\comment{
the interface and the implementation does not match
}
