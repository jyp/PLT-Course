...
\begin{question}{25}
    Write a logger module with the API defined above. For maximum points
    there should be at most one logger process running at a time. Also,
    do not use the functions \textsf{put} and \textsf{get}.
\begin{longanswer}
\begin{verbatim}
-module(logger).
