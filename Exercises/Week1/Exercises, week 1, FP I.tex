...
\begin{enumerate}
\item $\mathit{twice}~\mathit{inc}~0$ \percent{3}
\item $\mathit{twice}~\mathit{twice}~\mathit{inc}~0$ \percent{3}
% \item $\mathit{twice}~(\mathit{twice}~\mathit{twice})~\mathit{inc}~0$ \percent{3}
% \item $\mathit{twice}~\mathit{twice}~\mathit{twice}~\mathit{inc}~0$ \percent{3}
\item $(\lambda x.~x)~(\lambda x.~x)$ \percent{3}
\item $(\lambda x.~x~x)~(\lambda x.~x~x)$ \percent{3}
\end{enumerate}
...
\percent{18} This part of the exercise aims to give you some
